...
export const variant = () => (
  <Example>
    <Example.Item title="variant: underline">
      <Link href="http://smithcommerce.com" attributes={{ target: '_blank' }}>
        Smith Commerce
      </Link>
    </Example.Item>
...
export const withIcon = () => (
  <Example>
    <Example.Item title="icon, variant: underline">
      <Link icon={IconLightningChargeFill}>Link</Link>
    </Example.Item>
    <Example.Item title="icon, variant: plain">
      <Link icon={IconLightningChargeFill} variant="plain">
        Link
      </Link>
    </Example.Item>
    <Example.Item
    ...
    >
      <Text variant="title-3">
        <Link icon={IconLightningChargeFill} variant="underline">
          Instant delivery
        </Link>
      </Text>
    </Example.Item>
...
export const testMultilineInText = () => (
  <Example>
    <Example.Item title="should wrap inside the text">
      <div>
        Someone asked me to write this text that is boring to ready for everyone
        and to add&nbsp;
