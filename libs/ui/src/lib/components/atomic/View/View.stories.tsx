...
import { Avatar, Button, Hidden, MenuItem, Tabs, Text } from '..';
import { View } from '.';
...
export const direction = () => (
  <Example title="Item 1 is another component, Item 2 is View.Item, Item 3 is text">
    ...
    >
      <View
        direction={{ s: 'column-reverse', m: 'row-reverse', l: 'row' }}
        gap={3}
      >
        <Placeholder>Item 1</Placeholder>
        <Placeholder>Item 2</Placeholder>
...
export const gap = () => (
  <Example>
    ...
    <Example.Item
      title={['responsive gap, direction: column', '[s] 4', '[m+] 8']}
    >
      <View gap={{ s: 4, m: 8 }}>
        <Placeholder>Item 1</Placeholder>
        <Placeholder>Item 2</Placeholder>
...
export const overflow = () => (
  <Example>
    <Example.Item
      title={[
        'overflow: hidden, radius: medium',
        'child background should have radius',
      ]}
    >
      <View
        height="100px"
...
const Animated = () => {
  const [background, setBackground] = React.useState<any>('neutral');
  return (
    <View gap={3} align="start">
      <Button
        onClick={() =>
          setBackground((prev: any) =>
            prev === 'neutral' ? 'primary' : 'neutral',
          )
        }
      >
        Change background
...
export const itemGapBefore = () => (
  <Example>
    <Example.Item
      title={[
        'gap: 4, 3rd item gapBefore: 10, direction: row',
        'increased gap',
      ]}
    >
      <View direction="row" gap={4}>
    ...
    <Example.Item
      title={['gap: 10, 3rd item gapBefore: 4, direction: row', 'reduced gap']}
    >
    ...
    <Example.Item
      title={['gap: 10, 3rd item gapBefore: 0, direction: row', 'removed gap']}
    >
      <View direction="row" gap={10}>
        <Placeholder />
        <Placeholder />
    ...
    <Example.Item
      title={[
        'gap: 4, 3rd item gapBefore: 10, direction: column',
        'increased gap',
      ]}
    >
    ...
    <Example.Item
      title={[
        'gap: 10, 3rd item gapBefore: 4, direction: column',
        'reduced gap',
      ]}
    >
    ...
    <Example.Item
      title={[
        'gap: 10, 3rd item gapBefore: 0, direction: column',
        'removed gap',
      ]}
    >
      <View direction="column" gap={10}>
    ...
    <Example.Item title="2nd item has grow, Avatar stays circle">
      <View direction="row" gap={3}>
        ...
        <View.Item grow>
          ...
          sprouts horseradish courgette maize spinach prairie turnip jícama
          coriander quandong gourd broccoli seakale gumbo. Parsley corn lentil
          zucchini radicchio maize burdock avocado sea lettuce. Garbanzo
