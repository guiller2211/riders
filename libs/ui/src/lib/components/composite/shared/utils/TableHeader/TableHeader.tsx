...
import { Actionable, Button, Icon, Text, TextField, View } from '../../../../atomic';
...
export const TableHeader = (props: TableHeaderProps) => {
  const { searchTerm, showSearcher, fieldNames, open } = props;
  ...
  return (
    <View>
      <View.Item columns={12}>
        {showSearcher && (
          <View paddingBottom={6} direction='row' gap={4}>
            <TextField
              name="order"
              placeholder='Buscar'
              size="xlarge"
