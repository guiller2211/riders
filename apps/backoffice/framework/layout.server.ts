...
function getHeaderNavigation() {
  return [
    {
      button: { message: 'Home', props: { href: AppRoutes.Home }  },
    
    },
    {
      button: { message: 'User' },
      nodes: [
        { button: { message: 'Customers', props: { href: AppRoutes.Customer } } },
      ],
    },
    {
      button: { message: 'Catalogo' },
      nodes: [
        { button: { message: 'Productos', props: { href: AppRoutes.Products } } },
      ],
    },
   /*  {
      button: { message: 'Multimedia' },
      nodes: [
        { button: { message: 'Media', props: { href: AppRoutes.Media } } },
      ],
    }, */
   
    {
      button: { message: 'Ordenes' },
      nodes: [
        { button: { message: 'Ordenes', props: { href: AppRoutes.Orders } } },
      ],
    },
    {
